!(function (v) {
  v.fn.floatingWhatsApp = function (e) {
    ...
    function C() {
      window.open("https://wa.me/" + i.phone + "?text=" + encodeURI(i.message));
    }
